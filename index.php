...
if(isset($_POST['fun_codigo']) || isset($_POST['fun_senha'])) {
    ...
    if(strlen($_POST['fun_codigo']) == 0) {
        ...
        echo '</script>';
    } else if(strlen($_POST['fun_senha']) == 0) {
        echo '<script language="javascript">';
        echo 'alert("Insira sua senha")';
        echo '</script>';
    } else {
        ...
        $sql_code = "SELECT * FROM funcionario WHERE fun_codigo = '$fun_codigo' AND fun_senha = '$fun_senha'";
...
<main class="form-signin">
  <form action="" method="POST">
    ...
    <div class="form-floating">
      <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="fun_senha">
