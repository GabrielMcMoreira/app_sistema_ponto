...
if(isset($_POST['fun_codigo'])) {
    ...
    if(strlen($_POST['fun_codigo']) == 0) {
        ...
        if($quantidade >= 1) {
            ...
            echo '<script language="javascript">';
            echo 'alert("Falha ao logar! identificador incorreto")';
            echo '</script>';
        }
    }
}
...
<main class="form-signin">
  <form action="" method="POST">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" style="margin-bottom: 20px" id="floatingInput" placeholder="ID" name="fun_codigo">
